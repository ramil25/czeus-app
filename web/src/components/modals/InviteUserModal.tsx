...
export function InviteUserModal({ open, form, setForm, onCancel, onInvite, loading }: InviteUserModalProps) {
  if (!open) return null;
        ...
        <form className="flex flex-col gap-4" onSubmit={e => { e.preventDefault(); onInvite(); }}>
          ...
          <div>
            ...
            <input
              ...
              onChange={e => setForm({ ...form, middle_name: e.target.value || undefined })}
              className="w-full border border-blue-300 rounded px-3 py-2 text-black bg-white"
              disabled={loading}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              value={form.position || ''}
              onChange={e => setForm({ ...form, position: e.target.value || undefined })}
              className="w-full border border-blue-300 rounded px-3 py-2 text-black bg-white"
              disabled={loading}
            />
          </div>
