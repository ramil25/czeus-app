...
export interface EditVoucherForm {
  amount: string;
  code: string;
  is_used: boolean;
}
...
interface EditVoucherModalProps {
  ...
  setForm: (form: EditVoucherForm) => void;
  onCancel: () => void;
  onSave: (form: EditVoucherForm) => void;
  isLoading?: boolean;
}
...
const EditVoucherModal: React.FC<EditVoucherModalProps> = ({
  ...
  const handleInputChange = (field: keyof EditVoucherForm, value: string | boolean) => {
