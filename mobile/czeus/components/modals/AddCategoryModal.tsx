...
import { CreateCategoryInput, Category } from '@/lib/categories';

interface AddCategoryModalProps {
  visible: boolean;
  onClose: () => void;
  onAdd: (input: CreateCategoryInput) => Promise<Category>;
}
        ...
        <View style={styles.footer}>
          ...
          <TouchableOpacity
            style={[
              styles.button,
              styles.addButton,
              (!categoryName.trim() || loading) && styles.disabledButton,
            ]}
